...
#rename FG3_PCT as 3PT%
df_processed.rename(columns={'FG3_PCT': '3PT%'}, inplace=True)
df_processed.rename(columns={'FG_PCT': 'FG%'}, inplace=True)


Player1 = 'Rudy Gobert'
Player2 = 'Walker Kessler'
# Simulated user selections
players_selected = [Player1, Player2]
stats_selected = ['PTS', 'REB', 'BLK', 'STL', 'FG%']



def format_data_for_player(player, stats):
    player_data = df_processed[df_processed['PLAYER_NAME'] == player].iloc[0]
...
output_filename = '/Users/tonysantoorjian/Documents/traditional_player_stats.csv'
